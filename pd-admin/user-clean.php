<?php
    ...
    include('includes/view/UserCleanView.php');
    include('includes/clean/UserClean.php');
...
<head>
    ...
    <script type="text/javascript">
        function confirmDelete() {
            var checkbox = confirm("Üyelerin silinmesini istiyormusunuz ?");
            if(checkbox == true) { return true; }
            else { window.alert("Üye silme işlemi iptal edildi !"); return false; }
        }
    </script>
</head>
<body>
		...
		<section>
			...
			<div class="SectionConText">
				<div class="UserMainHeader">
					<p><i class="fa fa-compass"></i>ÜYELER | SİL</p>
				</div>
				<?php UserCleanView($pdo); ?>
			</div>
