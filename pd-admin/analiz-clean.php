<?php
    ...
    include('includes/view/AnalizCleanView.php');
    include('includes/clean/AnalizClean.php');
...
<head>
    ...
    <script type="text/javascript">
        function confirmDelete() {
            var checkBox = confirm("Fotoğraf Analiz silinmesini onaylıyormusunuz ?");
            if(checkBox == true) { return true; }
            else { window.alert("Fotoğraf Analiz silme işlemi iptal edildi !"); return false; }
        }
    </script>
</head>
<body>
    ...
    <section>
        ...
        <div class="SectionConText">
            <div class="AnalizMainHeader">
                <p><i class="fa fa-compass"></i>FOTOĞRAF ANALİZ | SİL</p>
            </div>
            <?php AnalizCleanView($pdo); ?>
        </div>
