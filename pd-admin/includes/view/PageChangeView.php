<?php
    function PageChangeView($pdo) {
        ...
        page.id as PID, page.page_name, page.page_date, page.page_user,
        ...
        foreach($DataRecords as $pageView) {
            ...
            echo '<a href="page-changed.php?pageChange='.$pageView['PID'].'"><p><i class="fa fa-exchange"></i></p></a>';
