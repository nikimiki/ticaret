<?php
    ...
    include('includes/view/CommentCleanView.php');
    include('includes/clean/CommentClean.php');
...
<head>
    ...
    <script type="text/javascript">
        function confirmDelete() {
            var checkBox = confirm("Yorumları silinmesini istiyormusunuz ?");
            if(checkBox == true) { return true; }
            else { window.alert("Yorum silme işlemi iptal edildi !"); return false; }
        }
    </script>
</head>
<body>
		...
		<section>
			...
			<div class="SectionConText">
				<div class="CommentMainHeader">
					<p><i class="fa fa-compass"></i>YORUMLAR | SİL</p>
				</div>
				<?php CommentCleanView($pdo); ?>
			</div>
