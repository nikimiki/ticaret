<?php
    ...
    include('includes/view/SubCategoryCleanView.php');
    include('includes/clean/SubCategoryClean.php');
    ...
    <head>
        ...
        <script type="text/javascript">
            function confirmDelete() {
                var checkBox = confirm("Alt Kategorileri silinmesini onaylıyormusunuz ?");
                if(checkBox == true) { return true; }
                else { window.alert("Alt Kategori silme işlemi iptal edildi !"); return false; }
            }
        </script>
    </head>
    <body>
        ...
        <section>
            ...
            <div class="SectionConText">
                <div class="SubCategoryMainHeader">
                    <p><i class="fa fa-compass"></i>ALT KATEGORİLER | SİL</p>
                </div>
                <?php SubCategoryCleanView($pdo); ?>
            </div>
