<?php
    ...
    include('includes/view/MuayeneCleanView.php');
    include('includes/clean/MuayeneClean.php');
...
<head>
    ...
    <script type="text/javascript">
        function confirmDelete() {
            var checkBox = confirm("Muayene Talebi silinmesini onaylıyormusunuz ?");
            if(checkBox == true) { return true; }
            else { window.alert("Muayene Talebi silme işlemi iptal edildi !"); return false; }
        }
    </script>
</head>
<body>
    ...
    <section>
        ...
        <div class="SectionConText">
            <div class="MuayeneMainHeader">
                <p><i class="fa fa-compass"></i>MUAYENE TALEBİ | SİL</p>
            </div>
            <?php MuayeneCleanView($pdo); ?>
        </div>
