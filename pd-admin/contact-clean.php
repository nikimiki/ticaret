<?php
    ...
    include('includes/view/ContactCleanView.php');
    include('includes/clean/ContactClean.php');
...
<head>
    ...
    <script type="text/javascript">
        function confirmDelete() {
            var checkBox = confirm("İletişim Bilgilerinin silinmesini onaylıyormusunuz ?");
            if(checkBox == true) { return true; }
            else { window.alert("İletişim Bilgilerinin silme işlemi iptal edildi !"); return false; }
        }
    </script>
</head>
<body>
    ...
    <section>
        ...
        <div class="SectionConText">
            <div class="ContactMainHeader">
                <p><i class="fa fa-compass"></i>İLETİŞİM | SİL</p>
            </div>
            <?php ContactCleanView($pdo); ?>
        </div>
