<?php
    ...
    include('includes/view/NoticeCleanView.php');
    include('includes/clean/NoticeClean.php');
...
<head>
    ...
    <script type="text/javascript">
        function confirmDelete() {
            var checkBox = confirm("Duyuruların silinmesini istiyormusunuz ?");
            if(checkBox == true) { return true; }
            else { window.alert("Duyuru silme işlemi iptal edildi !"); return false; }
        }
    </script>
</head>
<body>
		...
		<section>
			...
			<div class="SectionConText">
				<div class="NoticeMainHeader">
					<p><i class="fa fa-compass"></i>DUYURULAR | SİL</p>
				</div>
				<?php NoticeCleanView($pdo); ?>
			</div>
