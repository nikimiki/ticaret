<?php
    ...
    include('includes/view/VideoCleanView.php');
    include('includes/clean/VideoClean.php');
...
<head>
    ...
    <script type="text/javascript">
        function confirmDelete() {
            var checkBox = confirm("Videoların silinmesini istiyormusunuz ?");
            if(checkBox == true) { return true; }
            else { window.alert("Video silme işlemi iptal edildi !"); return false; }
        }
    </script>
</head>
<body>
		...
		<section>
			...
			<div class="SectionConText">
				<div class="VideoMainHeader">
					<p><i class="fa fa-compass"></i>MEDYA VİDEO | SİL</p>
				</div>
				<?php VideoCleanView($pdo); ?>
			</div>
