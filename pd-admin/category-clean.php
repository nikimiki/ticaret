<?php
    ...
    include('includes/view/CategoryCleanView.php');
    include('includes/clean/CategoryClean.php');
...
<head>
    ...
    <script type="text/javascript">
        function confirmDelete() {
            var checkBox = confirm("Kategorileri silinmesini onaylıyormusunuz ?");
            if(checkBox == true) { return true; }
            else { window.alert("Kategori silme işlemi iptal edildi !"); return false; }
        }
    </script>
</head>
<body>
		...
		<section>
			...
			<div class="SectionConText">
				<div class="CategoryMainHeader">
					<p><i class="fa fa-compass"></i>KATEGORİLER | SİL</p>
				</div>
				<?php CategoryCleanView($pdo); ?>
			</div>
