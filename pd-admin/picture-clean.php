<?php
    ...
    include('includes/view/PictureCleanView.php');
    include('includes/clean/PictureClean.php');
...
<head>
    ...
    <script type="text/javascript">
        function confirmDelete() {
            var checkBox = confirm("Resimlerin silinmesini istiyormusunuz ?");
            if(checkBox == true) { return true; }
            else { window.alert("Resim silme işlemi iptal edildi !"); return false; }
        }
    </script>
</head>
<body>
		...
		<section>
			...
			<div class="SectionConText">
				<div class="PictureMainHeader">
					<p><i class="fa fa-compass"></i>MEDYA GÖRSEL | SİL</p>
				</div>
                <?php PictureCleanView($pdo); ?>
			</div>
